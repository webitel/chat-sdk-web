import type { AnonymousSchema_20 } from './AnonymousSchema_20';
import type { WsPeer } from './WsPeer';
...
class WsMessage {
	...
	get sender(): WsPeer | undefined {
		return this._sender;
	}
	set sender(sender: WsPeer | undefined) {
		this._sender = sender;
	}
	...
	/**
	 * Discriminator for the content field
	 */
	get reservedType(): AnonymousSchema_20 | undefined {
		return this._reservedType;
	}
	set reservedType(reservedType: AnonymousSchema_20 | undefined) {
		this._reservedType = reservedType;
	}

	/**
	 * Media payload (image/document metadata)
	 */
	get content(): Map<string, any> | undefined {
		return this._content;
	}
	set content(content: Map<string, any> | undefined) {
